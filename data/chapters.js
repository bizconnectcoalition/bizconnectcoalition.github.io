...
window.BCC_CHAPTERS = [
  {
    slug:"nac", logo:"assets/img/chapters/nac.jpg", name:"Newtown Athletic Club", family:"member", region:"northeast",
  ...
  {
    slug:"berks-moms-in-motion", logo:"assets/img/chapters/berks-moms-in-motion.png", name:"Berks Moms in Motion", family:"member", region:"northeast",
  ...
  {
    slug:"veteran-biz-connect", logo:"assets/img/chapters/veteran-biz-connect.png", name:"Veteran Biz Connect", family:"veteran", region:"northeast",
  ...
  {
    slug:"heroes-biz-connect", logo:"assets/img/chapters/heroes-biz-connect.png", name:"Heroes Biz Connect", family:"heroes", region:"northeast",
  ...
  {
    slug:"spa23", logo:"assets/img/chapters/spa23.png", name:"Spa23 Business Coalition", family:"member", region:"northeast",
  ...
  {
    slug:"vfw-post-9045", logo:"assets/img/chapters/vfw-post-9045.png", name:"VFW Post 9045", family:"veteran", region:"northeast",
  ...
  {
    slug:"conwell-egan", logo:"assets/img/chapters/conwell-egan.png", name:"Conwell-Egan Catholic HS", family:"alumni", region:"northeast",
  ...
  {
    slug:"cranford-hs", logo:"assets/img/chapters/cranford-hs.png", name:"Cranford HS Alumni", family:"alumni", region:"northeast",
  ...
  {
    slug:"spring-grove", logo:"assets/img/chapters/spring-grove.png", name:"Spring Grove HS Alumni", family:"alumni", region:"northeast",
  ...
  {
    slug:"villa-joseph-marie", logo:"assets/img/chapters/villa-joseph-marie.jpg", name:"Villa Joseph Marie", family:"alumni", region:"northeast",
    loc:"Holland, PA", status:"forming", pin:[856.24,230.47],
    desc:"VJM alumnae supporting each other's practices, firms, and ventures."
  },
  {
    slug:"wayne-hs", logo:"assets/img/chapters/wayne-hs.jpg", name:"Wayne High School Alumni", family:"alumni", region:"northeast",
    loc:"Wayne, NJ", status:"forming", pin:[864.13,212.05],
    desc:"Wayne graduates networking around the connection that never graduates."
  },
  {
    slug:"cr-alumni", logo:"assets/img/chapters/cr-alumni.jpg", name:"CR Alumni Biz Connect", family:"alumni", region:"northeast",
  ...
  {
    slug:"temple-baseball", logo:"assets/img/chapters/temple-baseball.png", name:"Temple Baseball Alumni", family:"alumni", region:"northeast",
    loc:"Philadelphia, PA", status:"forming", pin:[854.26,236.47],
    desc:"Former Owls ballplayers keeping the roster together in business."
  },
  {
    slug:"passaic-county", logo:"assets/img/chapters/passaic-county.jpg", name:"Passaic County", family:"member", region:"northeast",
  ...
  {
    slug:"metro-adjusters", logo:"assets/img/chapters/metro-adjusters.jpg", name:"Metro Adjusters", family:"member", region:"northeast",
  ...
  {
    slug:"pa-fitness", logo:"assets/img/chapters/pa-fitness.png", name:"PA Fitness", family:"member", region:"northeast",
    loc:"Pennsylvania", status:"forming", pin:[845.9,223.75],est:1,est:1,
    desc:"Members of PA Fitness connecting reps to referrals."
  },
  {
    slug:"non-stop-fitness", logo:"assets/img/chapters/non-stop-fitness.jpg", name:"Non Stop Fitness", family:"member", region:"northeast",
  ...
  {
    slug:"retro-fitness", logo:"assets/img/chapters/retro-fitness.jpg", name:"Retro Fitness", family:"member", region:"northeast",
  ...
  {
    slug:"garage-barre", logo:"assets/img/chapters/garage-barre.jpg", name:"Garage Barre", family:"member", region:"northeast",
  ...
  {
    slug:"arete-syndicate", logo:"assets/img/chapters/arete-syndicate.jpg", name:"Arete Syndicate", family:"circle", region:"northeast",
  ...
  {
    slug:"defiant-syndicate", logo:"assets/img/chapters/defiant-syndicate.jpg", name:"Defiant Syndicate", family:"circle", region:"northeast",
  ...
  {
    slug:"medlogic", logo:"assets/img/chapters/medlogic.png", name:"MedLogic", family:"member", region:"northeast",
  ...
  {
    slug:"real-estate-show", logo:"assets/img/chapters/real-estate-show.jpg", name:"The Real Estate Show", family:"member", region:"northeast",
  ...
  {
    slug:"connector-street", logo:"assets/img/chapters/connector-street.png", name:"Connector Street", family:"member", region:"northeast",
  ...
  {
    slug:"fhaa", logo:"assets/img/chapters/fhaa.png", name:"FHAA", family:"alumni", region:"northeast",
  ...
  {
    slug:"salve-regina-nursing", logo:"assets/img/chapters/salve-regina-nursing.png", name:"Salve Regina Nursing", family:"alumni", region:"northeast",
  ...
  {
    slug:"southern-tier", logo:"assets/img/chapters/southern-tier.jpg", name:"Southern Tier", family:"member", region:"northeast",
  ...
  {
    slug:"uwm", logo:"assets/img/chapters/uwm.png", name:"UWM Alumni", family:"alumni", region:"midwest",
  ...
  {
    slug:"halstead-high", logo:"assets/img/chapters/halstead-high.png", name:"Halstead High Alumni", family:"alumni", region:"midwest",
  ...
  {
    slug:"virginia-beach", logo:"assets/img/chapters/virginia-beach.png", name:"Virginia Beach", family:"member", region:"south",
  ...
  {
    slug:"uss-america", logo:"assets/img/chapters/uss-america.jpg", name:"USS America", family:"veteran", region:"south",
  ...
  {
    slug:"swfl-entrepreneurs", logo:"assets/img/chapters/swfl-entrepreneurs.jpg", name:"SWFL Entrepreneurs", family:"member", region:"south",
  ...
  {
    slug:"san-carlos-park", logo:"assets/img/chapters/san-carlos-park.png", name:"San Carlos Park", family:"member", region:"south",
